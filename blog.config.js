...
const BLOG = {
  ...
  // Important page_id！！！Duplicate Template from https://sun-weight-e75.notion.site/2b9d172ee145810c8479de06f08d9f04?v=2b9d172ee14581979b19000cf1defd67&source=copy_link
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '空空海淘玩具店', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'KONGKONG TOYS', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.kongkongtoys.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Toys,Cars,figures,玩具', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，欢迎来到我的店铺，Hi，welcome to my shop 🎉',
